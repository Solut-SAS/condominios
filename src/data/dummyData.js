...
const recurrentAnnotations = [
	{
		id: 1,
		to: [{id: 1, name: 'Torre 2'}, {id: 2, name:'Mnza 3'}, {id: 3, name:'Torre 2 903'}],
		content: 'Llegaron los recibos de gas, porfavor venir por ellos a portería'
	},
	{
		id: 2,
		to: [{id: 4, name: 'Torre 6'}, {id: 9, name:'Mnza 5'}, {id: 5, name:'Torre 5 905'}],
		content: 'Ascensor en mantenimiento'
	},
	{
		id: 3,
		to: [{id: 2, name: 'Torre 7'}, {id: 8, name:'Mnza 5'}, {id: 56, name:'Torre 5 905'}],
		content: 'Por favor pagar la administración'
	},
	{
		id: 4,
		to: [{id: 34, name: 'Torre 8'}, {id: 8, name:'Mnza 5'}, {id: 89, name:'Torre 5 905'}],
		content: 'Por favor pagar la administración'
	}
]
...
const recentAnnotations = [
	...
	{
		id: 2,
		to: [{id: 4, name: 'Torre 5'}, {id: 43, name:'Mnza 5'}, {id: 5, name:'Torre 5 905'}],
		content: 'Ascensor en mantenimiento'
	},
	{
		id: 3,
		to: [{id: 5, name: 'Torre 5'}, {id: 44, name:'Mnza 5'}, {id: 22, name:'Torre 5 905'}],
		content: 'Por favor pagar la administración'
	},
	{
		id: 4,
		to: [{id: 6, name: 'Torre 5'}, {id: 54, name:'Mnza 5'}, {id: 53, name:'Torre 5 905'}],
		content: 'Por favor pagar la administración'
	}
]
